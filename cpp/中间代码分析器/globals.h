...
vector<string> Ta, Tb;  // 归约符号(非终结符为空)列表
vector<Quad*> Qd;  // 开辟过的四元组
vector<QP> Qp;
set<int> Tmps;  // 已用的临时变量编号
vector<string> Rels;  // 将要释放的临时变量名称
set<string> Hids{ "跳过", "引用", "调用", "定义", "参数", "返回" };  // 要隐藏的op操作
